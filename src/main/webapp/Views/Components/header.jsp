...
<%@ page import="ecommerce_proyect.Model.CategoriaModel" %>
...
<html>
    <head>
        ...
        <script>
            ...
            function verCategoria(idCategoria) {
                window.location.href = "Categoria?id=" + idCategoria;
            }
    ...
    <body>
        ...
        <%
            ...
            List<CategoriaModel> categorias = catDao.listarCategorias();
        %>
        ...
        <header>
            <nav>
                ...
                <div class="categories">
                    <ul>
                        <li><a href="HomeController">Inicio</a></li>
                        <li class="dropdown">
                            <a href="#">Categorías</a>
                            <div class="dropdown-content">
                                <% for (CategoriaModel c : categorias) {%>
                                <a href="Categoria?categoriaNombre=<%=java.net.URLEncoder.encode(c.getCatNombre(), "UTF-8")%>">
                                    <%= c.getCatNombre()%>
                                </a>
                                <% }%>
                            </div>
